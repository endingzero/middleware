package cn.zerer.middleware.whitelist;

import cn.zerer.middleware.whitelist.annotation.DoWhiteList;
...
public class DoJoinPoint {
    ...
    @Pointcut("@annotation(cn.zerer.middleware.whitelist.annotation.DoWhiteList)")
